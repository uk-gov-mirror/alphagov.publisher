...
class GenericEditionPresenterTest < ActiveSupport::TestCase
  ...
  context ".render_for_fact_check_manager_api" do
    should "return a hash with the body content if present" do
      ...
      assert_equal({ content: { 'body': "<p>Move your body</p>" } }, presenter.render_for_fact_check_manager_api)
    end
    ...
    should "return a hash with an empty string if body is nil" do
      ...
      assert_equal({ content: { 'body': "" } }, presenter.render_for_fact_check_manager_api)
    end
  end
end
